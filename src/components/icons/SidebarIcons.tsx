...
export const HomeIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
    <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 12l8.954-8.955a1.5 1.5 0 012.122 0l8.954 8.955M3 11.25V21.75a.75.75 0 00.75.75h4.5a.75.75 0 00.75-.75v-6a.75.75 0 01.75-.75h3a.75.75 0 01.75.75v6a.75.75 0 00.75.75h4.5a.75.75 0 00.75-.75V11.25" />
  </svg>
);
...
export const BriefcaseIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
    ...
    <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 14.15v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m5.231 13.5h-3.86" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 18.375a3.375 3.375 0 003.375-3.375V8.625A3.375 3.375 0 0012 5.25" />
  </svg>
);
...
export const BookOpenIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 6.253v11.494m-5.495-11.494L12 12.5m5.495-6.247L12 12.5M3.75 6.75h16.5v10.5H3.75z" />
  </svg>
);
...
export const BuildingLibraryIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 21v-8.25M15.75 21v-8.25M8.25 21v-8.25M3 9l9-6 9 6m-1.5-3.086V3M3.75 6.086V3m13.5 18H3.75c-.621 0-1.125-.504-1.125-1.125V8.25c0-.621.504-1.125 1.125-1.125h16.5c.621 0 1.125.504 1.125 1.125v11.625c0 .621-.504 1.125-1.125 1.125z" />
  </svg>
);
...
export const ChatBubbleLeftRightIcon = ({ className = "w-6 h-6" }) => (
